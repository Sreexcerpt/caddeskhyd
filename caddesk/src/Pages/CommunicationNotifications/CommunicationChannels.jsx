							...
							<div class="messages">
								<div class="chats">
									<div class="chat-avatar">
										<img src="assets/img/profiles/avatar-02.jpg" class="rounded-circle dreams_chat"
											alt="image"/>
									</div>
								...
								<div class="chats chats-right">
									...
									<div class="chat-avatar">
										<img src="assets/img/profiles/avatar-10.jpg" class="rounded-circle dreams_chat"
											alt="image"/>
									</div>
								</div>
								<div class="chats">
									...
									<div class="chat-content">
										...
										<div class="message-content review-files">
											<p class="d-flex align-items-center">Please check and review the files<span
													class="ms-1 d-flex"><img src="assets/img/icons/smile-chat.svg"
														alt="Icon"/></span></p>
										...
										<div class="like-chat-grp">
											<ul>
												<li class="like-chat"><a href="javascript:void(0);">2<img
															src="assets/img/icons/like.svg" alt="Icon"/></a></li>
												<li class="comment-chat"><a href="javascript:void(0);">2<img
															src="assets/img/icons/heart.svg" alt="Icon"/></a></li>
											</ul>
										</div>
									</div>
								</div>
						...
						<form>
							...
							<div class="smile-foot emoj-action-foot">
								...
								<div class="emoj-group-list-foot down-emoji-circle">
									<ul>
										<li><a href="javascript:void(0);"><img src="assets/img/icons/emoj-icon-01.svg"
													alt="Icon"/></a></li>
										<li><a href="javascript:void(0);"><img src="assets/img/icons/emoj-icon-02.svg"
													alt="Icon"/></a></li>
										<li><a href="javascript:void(0);"><img src="assets/img/icons/emoj-icon-03.svg"
													alt="Icon"/></a></li>
										<li><a href="javascript:void(0);"><img src="assets/img/icons/emoj-icon-04.svg"
													alt="Icon"/></a></li>
										<li><a href="javascript:void(0);"><img src="assets/img/icons/emoj-icon-05.svg"
													alt="Icon"/></a></li>
										<li class="add-emoj"><a href="javascript:void(0);"><i
													class="bx bx-plus"></i></a></li>
									</ul>
								...
								<div class="mt-0 right_sidebar_logo">
									<div class="text-center right-sidebar-profile">
										...
										<div class="chat-options chat-option-profile">
											<ul class="list-inline">
												<li class="list-inline-item">
													<a href="audio-call.html" class="btn btn-outline-light "
												...
												<li class="list-inline-item ">
													<a href="video-call.html" class="btn btn-outline-light profile-open"
														data-bs-toggle="tooltip" data-bs-placement="bottom"
														title="Video Call">
														<i class="bx bx-video"></i>
													</a>
									...
									<div class="chat-member-details">
										<div class="member-details">
											<ul>
												...
												<li>
													<h6>Email Address</h6>
													<span><a href="/cdn-cgi/l/email-protection" class="__cf_email__" data-cfemail="21484f474e614459404c514d440f424e4c">[email&#160;protected]</a></span>
												</li>
											</ul>
										</div>
									</div>
									...
									<div class="tab-content pt-0" id="nav-tabContent">
										...
										<div class="tab-pane fade" id="link">
											<div class="media-link-grp">
												<div class="link-img">
													<a href="javascript:void(0);"><img
															src="assets/img/media/media-link-01.jpg" alt="Img"/></a>
												</div>
											...
											<div class="media-link-grp mb-0">
												<div class="link-img">
													<a href="javascript:void(0);"><img
															src="assets/img/media/media-link-02.jpg" alt="Img"/></a>
												</div>
												<div class="media-link-detail">
