    ...
    <div>
              ...
              <div class="page-header">
                <div class="row align-items-center">
                  <div class="col-4">
                    <h4 class="page-title">
                      Lead Assignment & Follow-ups
                      <span class="count-title">420</span>
                    </h4>
                  </div>
                ...
                <div class="card-body">
                  ...
                  <div class="d-flex align-items-center justify-content-between flex-wrap row-gap-2 mb-4">
                    <div class="sort-dropdown drop-down task-drops">
                      ...
                      >
                        All Leads Assignment & Follow-ups
                      </a>
                        ...
                        <li class="task-wrap pending">
                          ...
                          <div class="task-actions">
                            <ul>
                              ...
                              <li class="task-date">
                                <i class="ti ti-calendar-exclamation"></i>25 Oct
                                2024
                              </li>
                              <li class="task-owner">
                        ...
                        <li class="task-wrap  warning">
                          ...
                          <div class="task-actions">
                            <ul>
                              ...
                              <li class="task-date">
                                <i class="ti ti-calendar-exclamation"></i>2 Act
                                2024
                              </li>
                              <li class="task-owner">
                                <div class="dropdown table-action">
                  ...
                  <div class="task-wrapper">
                    ...
                    <div
                      class="tasks-activity tasks collapse show"
                      id="yesterday"
                    >
                      <ul>
                        <li class="task-wrap  warning">
                          ...
                          <div class="task-actions">
                            <ul>
                              <li class="task-time">
                                <span class="badge badge-tag badge-warning-light">
                                  Under Review
                                </span>
                              </li>
                              <li class="task-date">
                                <i class="ti ti-calendar-exclamation"></i>24 Oct
                                2023
                              </li>
                              <li class="task-owner">
                                <div class="dropdown table-action">
                        ...
                        <li class="task-wrap  success">
                          <div class="task-info">
                            ...
                            <span class="badge badge-pill badge-status bg-purple">
                              <i class="ti ti-user-share"></i>Meeting
                            </span>
                          </div>
                          <div class="task-actions">
                            <ul>
                              ...
                              <li class="task-date">
                                <i class="ti ti-calendar-exclamation"></i>22 Oct
                                2023
                              </li>
                              <li class="task-owner">
                                <div class="dropdown table-action">
      ...
      >
        ...
        <div class="offcanvas-body">
          <div class="card">
            <div class="card-header">
              <h5 class="card-title">Add Leads Assignment Form</h5>
            </div>
